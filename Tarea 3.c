...
// Función para buscar un nodo en el árbol por su rut
...
// Función auxiliar para actualizar los ruts y generar el archivo de salida
...
// Función auxiliar recursiva para generar el archivo de salida
